export const enUS = {
  ...
  detail: {
    ...
    noActionItems: 'No action items found in this meeting.',
    aiGeneratedAt: (model: string): string => `Generated by ${model}`,
    aiError: 'AI generation failed. Please check your API key and try again.',
    assignee: 'Assignee'
  },
  settings: {
    ...
    localRecognitionMode: 'Local Recognition Strategy',
    ...
    localServerModeLocal: 'Local (Auto-start)',
    localServerModeRemote: 'Remote (LAN)',
    ...
    validateTranslation: 'Validate',
    translationTesting: 'Validating…',
    translationTestIdle: 'Translation service status: Not tested',
    translationTestSuccess: 'Translation service status: Available',
    translationTestFailed: 'Translation service status: Unavailable',
    theme: 'Theme',
    system: 'System',
    light: 'Light',
    dark: 'Dark',
