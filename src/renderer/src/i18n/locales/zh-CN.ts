...
export const zhCN: typeof enUS = {
  ...
  meeting: {
    ...
    emptyStep1: '在设置中确认识别引擎已配置。',
    emptyStep2: '确保要采集的音频正在本设备上播放。',
    emptyStep3: '点击下方"开始录音"。',
  ...
  settings: {
    ...
    localServerModeLocal: '本地（自动启动）',
    localServerModeRemote: '远程（局域网）',
    ...
    validateTranslation: '验证',
    translationTesting: '验证中…',
    translationTestIdle: '翻译服务状态：未验证',
    translationTestSuccess: '翻译服务状态：可用',
    translationTestFailed: '翻译服务状态：不可用',
    theme: '主题',
    system: '跟随系统',
    light: '浅色',
    dark: '深色',
