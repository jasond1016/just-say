    ...
    <section className="flex min-w-0 flex-1 flex-col page-enter">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-auto px-8 pb-8">
        <div className="max-w-3xl">
          ...
          {/* ─── Stats + Meeting CTA — side by side ─── */}
          <div className="grid grid-cols-[1fr,auto] gap-8 pt-5 pb-5 border-b border-border">
            {/* Left: Stats */}
            ...
            <div className="flex items-start pt-1">
              <button
                ...
                className="press-scale group flex flex-col items-center gap-2.5 rounded-xl border border-border bg-card px-6 py-5 shadow-tinted-sm transition-all duration-200 hover:shadow-tinted-md hover:border-primary/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
              >
                ...
                <Play className="h-3.5 w-3.5 text-muted-foreground/40 group-hover:text-primary transition-colors" />
              </button>
            </div>
          </div>
